...
bg-base-100 p-3..p-4; rounded-lg при этом ничего не скругляет — коробки в
этом интерфейсе прямоугольные, см. borderRadius в tailwind.config.js).
Раньше здесь была shadow-sm — на «Библии»/«Песнях»/«Звуке» статичные панели всегда плоские,
