...
export function CloseScreen(name) {
    let $resultPromise = /** @type {any} */($Call.ByID(3315312654, name));
 ...
 * @returns {Promise<void> & { cancel(): void }}
 */
export function ShowScreen(x, y, sizeX, sizeY, name) {
    let $resultPromise = /** @type {any} */($Call.ByID(3622692775, x, y, sizeX, sizeY, name));
    return $resultPromise;
}
